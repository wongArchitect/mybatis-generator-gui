 ...
 */
public class GeneratorConfigBatchController extends BaseFXController {

    private static final Logger _LOG = LoggerFactory.getLogger(GeneratorConfigBatchController.class);
    ...
    private GeneratorConfigBatchController controller;
                    ...
                    if (item == null || empty) {
                        ...
                        btn1.setOnAction(event -> {
                            try {
                                ...
                                mainUIBatchController.setGeneratorConfigIntoUI(generatorConfig);
    ...
    void setMainUIBatchController(MainUIBatchController mainUIBatchController) {
