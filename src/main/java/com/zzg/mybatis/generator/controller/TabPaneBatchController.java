 ...
 */
public class TabPaneBatchController extends BaseFXController {
    private static Logger logger = LoggerFactory.getLogger(TabPaneBatchController.class);
    ...
    public void setMainUIBatchController(MainUIBatchController mainUIBatchController) {
        ...
        this.tabControlAController.setMainUIBatchController(mainUIBatchController);
        this.tabControlBController.setMainUIBatchController(mainUIBatchController);
    }
